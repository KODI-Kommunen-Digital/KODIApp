...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( UserModel? userDetail,  String userImage,  int userId,  bool isAdmin)?  loaded,TResult Function( String error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case PostDetailInitial() when initial != null:
return initial();case PostDetailLoading() when loading != null:
return loading();case PostDetailLoaded() when loaded != null:
return loaded(_that.userDetail,_that.userImage,_that.userId,_that.isAdmin);case PostDetailError() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( UserModel? userDetail,  String userImage,  int userId,  bool isAdmin)  loaded,required TResult Function( String error)  error,}) {final _that = this;
switch (_that) {
case PostDetailInitial():
return initial();case PostDetailLoading():
return loading();case PostDetailLoaded():
return loaded(_that.userDetail,_that.userImage,_that.userId,_that.isAdmin);case PostDetailError():
return error(_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( UserModel? userDetail,  String userImage,  int userId,  bool isAdmin)?  loaded,TResult? Function( String error)?  error,}) {final _that = this;
switch (_that) {
case PostDetailInitial() when initial != null:
return initial();case PostDetailLoading() when loading != null:
return loading();case PostDetailLoaded() when loaded != null:
...
class PostDetailLoaded implements PostDetailState {
  const PostDetailLoaded(this.userDetail, this.userImage, this.userId, this.isAdmin);
...
@override
int get hashCode => Object.hash(runtimeType,userDetail,userImage,userId,isAdmin);
...
/// Create a copy of PostDetailState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? userDetail = freezed,Object? userImage = null,Object? userId = null,Object? isAdmin = null,}) {
  return _then(PostDetailLoaded(
freezed == userDetail ? _self.userDetail : userDetail // ignore: cast_nullable_to_non_nullable
as UserModel?,null == userImage ? _self.userImage : userImage // ignore: cast_nullable_to_non_nullable
as String,null == userId ? _self.userId : userId // ignore: cast_nullable_to_non_nullable
as int,null == isAdmin ? _self.isAdmin : isAdmin // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
class PostDetailError implements PostDetailState {
  const PostDetailError(this.error);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PostDetailError&&(identical(other.error, error) || other.error == error));
}
